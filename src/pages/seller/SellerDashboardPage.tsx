            ...
            <div className="card-body p-4">
              ...
              <div className="mb-4 border-b border-base-200 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold">TechWorld</p>
...
function Overview() {
  const stats = [
    { label: 'Ventes', value: '1 250', icon: 'M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z' },
    { label: 'Produits', value: '120', icon: 'M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z' },
    { label: 'Commandes', value: '340', icon: 'M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12' },
    { label: 'Note moyenne', value: '4.8', icon: 'M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z' },
  ]

  return (
    <div>
      <h1 className="mb-6 text-2xl font-black">Bonjour, TechWorld !</h1>
        ...
        <div className="card-body">
          ...
          <div className="mt-3 flex items-center justify-between rounded-xl bg-base-200 p-4">
            <div>
              ...
              <p className="text-sm text-base-content/60">12 août 2026 · Smartphone X200</p>
            </div>
            <span className="badge badge-warning badge-outline">À expédier</span>
          </div>
        </div>
      </div>
    </div>
...
function Products() {
  ...
  const [products, setProducts] = useState([
    { name: 'Smartphone X200', price: '299 990 FCFA', stock: 45, status: 'Actif' },
    { name: 'Casque Bluetooth', price: '49 990 FCFA', stock: 120, status: 'Actif' },
    { name: 'Coque de protection', price: '5 990 FCFA', stock: 0, status: 'Rupture' },
  ])
...
function Orders() {
  const orders = [
    { id: '#CMD-2026-0842', date: '12 août 2026', total: '299 990 FCFA', status: 'À expédier', client: 'Awa Koné' },
    { id: '#CMD-2026-0791', date: '28 juillet 2026', total: '49 990 FCFA', status: 'Expédiée', client: 'Jean-Marc' },
    { id: '#CMD-2026-0654', date: '15 juin 2026', total: '5 990 FCFA', status: 'Livrée', client: 'Fatou' },
  ]
...
function Reviews() {
  const reviews = [
    { client: 'Awa Koné', rating: 5, comment: 'Excellent produit, livraison rapide !' },
    { client: 'Jean-Marc', rating: 4, comment: 'Très bon rapport qualité/prix.' },
  ]
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="form-control">
                ...
                <input type="text" defaultValue="TechWorld" className="input input-bordered w-full" />
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text">E-mail</span>
                </label>
                <input type="email" defaultValue="vendeur@techworld.com" className="input input-bordered w-full" />
              </div>
            </div>
            ...
            <div className="form-control">
              ...
              <textarea
                defaultValue="Boutique spécialisée en électronique et accessoires high-tech."
                className="textarea textarea-bordered w-full"
                rows={3}
              />
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="form-control">
                ...
                <input type="text" defaultValue="+225 07 00 00 00 00" className="input input-bordered w-full" />
              </div>
              <div className="form-control">
                <label className="label">
            ...
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="form-control">
                  ...
                  <input type="text" defaultValue="Jean Kouassi" className="input input-bordered w-full" />
                </div>
                <div className="form-control">
                  <label className="label">
                    <span className="label-text">E-mail</span>
